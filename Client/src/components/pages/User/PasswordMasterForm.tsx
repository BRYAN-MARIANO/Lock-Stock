    ...
    <section className="form-password w-screen h-screen flex justify-center items-center flex-col gap-7">
      ...
      <form className="flex flex-col w-2/4 gap-3" onSubmit={handleSubmit(postData)}>
        <label htmlFor="Password_Master_User" className="flex flex-col">
          ...
          <input className="border border-black rounded h-8" id="Password_Master_User" type="password" {...register('Password_Master_User')} />
        ...
        <label htmlFor="Confirm_Password" className="flex flex-col">
          ...
          <input className="border border-black rounded h-8" id="Confirm_Password" type="password" {...register('Confirm_Password')} />
        ...
        <label htmlFor="Question_Security_User" className="flex flex-col">
          ...
          <input className="border border-black rounded h-8" id="Question_Security_User" type="text" {...register('Question_Security_User')} />
        ...
        <label htmlFor="Answer_Security_User" className="flex flex-col">
          ...
          <input className="border border-black rounded h-8" id="Answer_Security_User" type="text" {...register('Answer_Security_User')} />
        ...
        <label htmlFor="Confirm_Answer" className="flex flex-col">
          ...
          <input className="border border-black rounded h-8" id="Confirm_Answer" type="text" {...register('Confirm_Answer')} />
          {errors.Confirm_Answer && <p className="text-red-500 font-medium">{errors.Confirm_Answer.message}</p>}
        </label>
        <input className="border border-black rounded h-8" type="submit" value="Confirmar" className="m-auto w-full rounded bg-primary text-white font-medium mt-4 h-10"/>
      </form>
    </section>
  </>
);
