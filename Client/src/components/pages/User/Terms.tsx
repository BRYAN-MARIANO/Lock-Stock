...
const Terms = (): React.JSX.Element => {
  return (
    <>
      ...
      <h1 className="text-center text-primary text-4xl font-medium">POLÍTICA DE PRIVACIDAD</h1> 

      <p>
        El presente Política de Privacidad establece los términos en que Lock &
        Stock usa y protege la información que es proporcionada por sus usuarios
      ...
      <article>
      <h2 className="text-primary font-medium text-xl">Información que es recogida </h2>
      <p>
      ...
      <article>
      <h2 className="text-primary font-medium text-xl">Uso de la información recogida</h2>
      <p>
        ...
        Lock & Stock está altamente comprometido para cumplir con el compromiso
      ...
      <article>
      <h2 className="text-primary font-medium text-xl">Cookies</h2>
      <p>
        ...
        respecto al tráfico web, y también facilita las futuras recurrente. Otra
        función que tienen las cookies es que con ellas las web pueden
      ...
      <h2 className="text-primary font-medium text-xl">Enlaces a Terceros</h2>
      <p>
      ...
      <article>
      <h2 className="text-primary font-medium text-xl">Control de su información personal</h2>
      <p>
        ...
        juez con un orden judicial. <br />
        Lock & Stock Se reserva el derecho de cambiar los términos de la
